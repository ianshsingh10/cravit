      ...
      <div className="max-w-md w-full mx-auto bg-white p-8 rounded-2xl shadow-lg">
        ...
        {providers?.google && (
          <button
            ...
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors duration-300 flex items-center justify-center gap-2"
          >
            <Image
              src="/google-icon.svg" // put a Google logo in /public folder
              alt=">"
              width={20}
              height={20}
            />
