        ...
        {step === "form" ? (
          ...
          <form onSubmit={handleVerifyOtp} className="space-y-4">
            ...
            <div className="relative">
                ...
                <input type="text" placeholder="Enter OTP" value={otp} onChange={(e) => setOtp(e.target.value)} maxLength="6" className="pl-10 border border-gray-300 p-3 rounded-lg w-full text-center tracking-[0.5em] focus:ring-2 focus:ring-orange-400 focus:border-transparent transition" required/>
            </div>
